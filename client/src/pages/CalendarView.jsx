...
export default function CalendarView() {
  ...
  useEffect(() => {
    fetch(`${API}/tasks?limit=100`, { credentials: "include" })
      .then(r => r.json())
  ...
  const tasksForDay = (d) => {
    const ds = dateStr(d);
    return tasks.filter(t => t.dueDate && t.dueDate.startsWith(ds));
  };
                ...
                {d && (
                  <>
                    <span style={{
                      ...
                      fontSize: 12.5, fontWeight: todayCell ? 700 : 400,
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                      {dayTasks.slice(0, 3).map(t => (
                        <div key={t.id} style={{
                          ...
                          padding: "1px 5px",
                          borderRadius: 3,
                          background: t.status === "done" ? "var(--success-subtle)"
                                    : t.status === "in-progress" ? "#fef3c7"
                                    : "var(--accent-subtle)",
                          color: t.status === "done" ? "var(--success)"
                               : t.status === "in-progress" ? "#92400e"
                               : "var(--accent)",
                          overflow: "hidden",
                      ...
                      {dayTasks.length > 3 && (
                        <span style={{ fontSize: 10.5, color: "var(--text-muted)", paddingLeft: 3 }}>
        ...
        <div style={{
          ...
          <div className="card" style={{ width: "100%", maxWidth: 420 }}>
            ...
            <div className="form-group">
              ...
              <select id="cal-project" value={form.projectId}
